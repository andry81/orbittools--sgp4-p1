...
public:
    ...
    */
    ...
    /**
    * Get the tle epoch year
    * @returns the tle epoch year
    */
    unsigned int EpochYear() const
    {
        return epoch_year_;
    }

    /**
    * Get the tle epoch day in year
    * @returns the tle epoch day in year
    */
    double EpochYearDay() const
    {
        return epoch_year_day_;
    }
